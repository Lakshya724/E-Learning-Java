...
<head>
    ...
    <style>
        /* (KEEPING YOUR EXISTING STYLES AS IS) */
        * {
            margin: 0;
            padding: 0;
...
<div class="course-grid">
    <%
        ...
        try {
            ...
            String sql = "SELECT * FROM Courses WHERE category = 'Web'";
    ...
    <div class="course-card">
      <img src="<%= request.getContextPath() + "/" + rs.getString("image_path") %>" alt="Course Image">


        <h3><%= rs.getString("course_name") %></h3>
        <p><b><%= rs.getString("professor_name") %></b></p>
        <br>
        <a href="course-details.jsp?course_id=<%= rs.getInt("course_id") %>" class="free-badge-link">
