...
<head>
    <meta charset="UTF-8">
    <title>Skill_Elevate - AI Courses</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<h2 class="course-title">All the skills related to Artificial Intelligence....</h2>

<div class="categories">
    <div class="category">Neural Networks</div>
    <div class="category">NLP</div>
    <div class="category">Computer Vision</div>
    <div class="category">Generative AI</div>
</div>
...
%>
    <div class="course-card">
        ...
        <p><b><%= professor %></b></p>
        <br>
        <a href="AIMLCourse.jsp?course_id=<%= courseId %>" class="free-badge-link">
